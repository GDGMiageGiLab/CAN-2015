package net.evoir.best14.service;

import static net.evoir.best14.utils.Reversed.reversed;
...
import net.evoir.best14.R;
import net.evoir.best14.event.NetworkOperationEvent;
import net.evoir.best14.model.Social;
import net.evoir.best14.utils.Authenticated;
import net.evoir.best14.utils.BusProvider;
...
public class SocialFetchService extends Service{
	 ...
	 final private static String LOG_TAG = SocialFetchService.class.getName();
	    ...
	    private void fetchInstagramPosts(){
	    	...
	    	mAQ.ajax("http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=20&q=http://instagram.com/tags/abidjan/feed/recent.rss", JSONObject.class, 30 * 60 * 1000, new AjaxCallback<JSONObject>() {
	            @Override
		...
		private class DownloadTwitterTask extends AsyncTask<String, Void, String> {
			...
			final static String TwitterStreamURL = "https://api.twitter.com/1.1/search/tweets.json?q=%23best14";
